...
# /home/shadlyd15/build-i686-elf/linux/output/bin/
...
# CC=/home/shadlyd15/build-i686-elf/linux/output/bin/i686-elf-gcc
# AS=/home/shadlyd15/build-i686-elf/linux/output/bin/i686-elf-as
# LD=/home/shadlyd15/build-i686-elf/linux/output/bin/i686-elf-ld
...
burn: dirs bootsect kernel
	dd if=/dev/zero of=$(PENDRIVE) bs=512 count=2880
	dd if=$(IMG) of=$(PENDRIVE) conv=notrunc bs=512 seek=0 count=1
	dd if=$(IMG) of=$(PENDRIVE) conv=notrunc bs=512 seek=1 count=2048
